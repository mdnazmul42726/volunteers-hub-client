...
const ModeratorLogin = () => {
    ...
    const handleLogin = (e) => {
        ...
        logInWithEmailAndPassword(email, password).then(result => {
            const updatedDoc = { displayName: result.user.displayName, creationTime: result.user.metadata.creationTime, lastSignInTime: result.user.metadata.lastSignInTime, position: 'Moderator' }

            navigate('/moderator_profile')
    ...
    //     googleAuthentication().then(result => console.log(result)).catch(err => console.log(err))
    // };
        ...
        <div className="" data-aos="zoom-out">
            <div className="pt-20 flex justify-center">
                <div className=" my-4 rounded-xl sm:px-6 px-4 py-8 max-w-md w-full h-max shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] max-lg:mx-auto">
                    <div className="">
                        <div className="mb-10">
                            <h3 className="text-3xl font-extrabold ">Moderator Login</h3>
                        </div>
